...
\- Assumed proportion of non-penetrant carriers: `r params$penetrance`
...
ggplot(params$thedataframe, aes(x = Age)) +
  ...
  annotate("segment", x = 0, xend = params$age, y = params$carrier, yend = params$carrier,
           linetype = "dotted", color = "steelblue", linewidth = 0.6) +
  annotate("segment", x = 0, xend = params$age, y = params$risk, yend = params$risk,
           linetype = "dotted", color = "firebrick", linewidth = 0.6) +
  annotate("segment", x = params$age, xend = params$age, y = 0, yend = max(params$carrier, params$risk),
