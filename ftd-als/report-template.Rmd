---
title: "Genetic Counseling Report for c9orf72RE ALS-FTD"
subtitle: "Report generated on `r params$date_time`"
output: pdf_document
header-includes:
...
***Warning**: The probabilities and risk estimates provided in this report are based on current models and available data. They represent statistical estimates and should not be interpreted as definitive predictions. Individual outcomes may vary, and these results do not guarantee the presence or absence of disease. Clinical decisions should be made considering comprehensive medical evaluation and genetic counseling.*
...
\noindent\fbox{%
  \parbox{\textwidth}{%
    - Estimated probability of carrying the c9orf72RE mutation: \textbf{`r round(params$carrier, 3)`}\\
    - Estimated probability of developing the disease in the next \textbf{`r params$nyears`} years: \textbf{`r round(params$risk, 3)`}
  }%
}
